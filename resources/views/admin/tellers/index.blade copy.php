...
@section('content_header')
    <h1 style="text-align: center">Reporte de E14</h1>
    <style>
        .long-text {
            white-space: nowrap;
        }
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <table id="example" class="display nowrap table-responsive" style="width:100%; font-size: 13px;">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($seller->gob1 <> null)
                        <td class="long-text" style="color: rgb(0, 169, 14)" >{{$seller->puesto}}</td>
                        @else
                        ...
                        @else
                        <td> <a href="{{route("admin.tellers.edit", $seller)}}" class="btn btn-primary btn-sm" style="font-size: 9px;">Reportar</a></td>
                        <td> <a href="{{route("admin.tellers.show", $seller)}}" class="btn btn-primary btn-sm" style="font-size: 9px;">Enviar E14</a></td>
...
@section('js')
    ...
    $(document).ready(function () {
       $('#example').DataTable({
            ...
            scrollY: "55vh", // Ajustar el alto al 50% de la pantalla
            scrollCollapse: true,
            "buttons": [
                {
                "extend": 'excelHtml5',
