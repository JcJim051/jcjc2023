...
{
    use HasFactory;
    protected $fillable = ['id', 'coddep', 'codmun', 'codzon', 'codpuesto', 'departamento', 'municipio', 'puesto', 'mesa', 'codigodemesa','codpar', 'cedula', 'nombre', 'email', 'telefono', 'dondevota', 'cosescru', 'status','statusani', 'reclamacion', 'observacion', 'censodemesa', 'votosenurna', 'votosincinerados', 'gob1', 'gob2', 'gob3' ,'gob4','gob5','gob6','gob7','gob8','gob9','gob10','gob11','nulos','enblanco','nomarcados','recuperados', 'statusrec','statusasistencia','remenmesa', 'created_at', 'updated_at', 'banco', 'modificadopor','modificadopor_pmu', 'status_reconteo', 'reporte_1', 'reporte_2', 'reporte_3'];
    // protected $casts = [
    //     'e14' => 'binary',
    // ];
